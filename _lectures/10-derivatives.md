...
$$
\begin{equation*} f'(a) = \frac{df}{dx} \bigg\vert_{x=a} = \lim_{x \rightarrow a} \frac{f(x)-f(a)}{x-a}. \end{equation*}
$$
...
$$
\begin{equation*} f'(a) = \frac{df}{dx} \bigg\vert_{x=a} = \lim_{h \rightarrow 0} \frac{f(a+h)-f(a)}{h}. \end{equation*}
$$
...
$$
\begin{equation*} f(a+h) = f(a) + Ch + O(h^2). \end{equation*}
$$
...
$$
\frac{f(a+h) - f(a)}{h} = C + O(h).
$$

Then taking the limit on both sides as $$h \rightarrow 0$$ shows that $$C = f'(a)$$.

Example Using the second and third definitions above, compute the derivative of $$f(x) = x^n$$, where $$n$$ is a positive integer. <button class="toggle" data-box="#box1">Answer</button>
...
Example Find the derivative of $$e^x$$ using the third definition. <button class="toggle" data-box="#box1a">Answer</button>
...
Example Find the derivative of $$f(x) = \sqrt{x}$$ using the third definition. <button class="toggle" data-box="#box1c">Answer</button>
...
$$
\frac{df}{dx} \quad \hbox{ or } \quad \frac{dy}{dx},
$$

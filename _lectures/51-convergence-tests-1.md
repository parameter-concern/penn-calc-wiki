...
(:latex:) \begin{equation*} \sum_{n=m}^\infty f(n) \hbox{ converges } \Longleftrightarrow \int_m^\infty f(x)dx \hbox{ converges}. \end{equation*} (:latexend:)
...
(:latex:) \begin{equation*} \int_1^\infty f(x)dx \leq \sum_{n=1}^\infty f(n) \leq \int_0^\infty f(x)dx. \end{equation*} (:latexend:)
...
(:latex:) \[ \sum_{n=2}^\infty \frac{1}{n \ln(n)} \] (:latexend:)
...
(:latex:) \begin{align*} \int_2^\infty \frac{1}{x \ln(x)} dx &= \int_{\ln(2)}^\infty \frac{1}{u} du
&= \ln(u) \bigg|^\infty_{\ln(2)}, \end{align*} (:latexend:)
...
(:latex:) \[ \sum_{n=1}^\infty \frac{n}{e^n} \] (:latexend:)
...
(:latex:) \[ \int_{x=1}^\infty \frac{x}{e^x} \, dx = \int_{x=1}^\infty xe^{-x} \, dx \] (:latexend:)
...
(:latex:) \begin{align*} \int_{x=1}^\infty xe^{-x} &= -xe^{-x} \bigg|_{x=1}^\infty - \int_{x=1}^\infty -e^{-x}\, dx
&= -xe^{-x} - e^{-x} \bigg|_{x=1}^\infty
&= 0 - (-e^{-1}-e^{-1})
&= \frac{2}{e}. \end{align*} (:latexend:)
...
(:latex:) \[ \int_{x=1}^\infty \frac{1}{x^p} \, dx \] (:latexend:)
...
(:latex:) \[ \sum_{n=2}^\infty \frac{1}{n (\ln n)^p} \] (:latexend:)
...
(:latex:) \[ \int_{x=2}^\infty \frac{1}{x (\ln x)^p} \, dx = \int_{u = \ln 2}^\infty \frac{1}{u^p} \, du. \] (:latexend:)
...
(:latex:) \[ \sum_{n=4} \frac{n^3-2n^2-10}{n^5+7} \] (:latexend:)
...
(:latex:) \[ \frac{n^3-2n^2-10}{n^5+7} < \frac{n^3}{n^5} = \frac{1}{n^2}, \] (:latexend:)

since the numerator on the left is smaller, and the denominator on the left is bigger. So

(:latex:) \[ \sum_{n=4}^\infty \frac{n^3-2n^2-10}{n^5+7} < \sum_{n=4}^\infty \frac{1}{n^2}. \] (:latexend:)

($\sum \frac{1}{n^2}$) converges (p-series test from above), and so

(:latex:) \[ \sum_{n=4}^\infty \frac{n^3-2n^2-10}{n^5+7} \] (:latexend:)
...
(:latex:) \[ \sum_{n=2}^\infty \frac{1}{\ln(n!)} \] (:latexend:)
...
(:latex:) \begin{align*} \sum \frac{1}{\ln(n!)} &< \sum \frac{1}{\ln(2^n)}
&= \sum \frac{1}{n \ln(2)}
&= \frac{1}{\ln 2} \sum \frac{1}{n}, \end{align*} (:latexend:)
...
(:latex:) \begin{align*} \sum \frac{1}{\ln(n!)} &> \sum \frac{1}{\ln(n^n)}
&= \sum \frac{1}{n \ln(n)}. \end{align*} (:latexend:)
...
(:latex:) \[ \lim_{n \rightarrow \infty} \frac{f(n)}{g(n)}. \] (:latexend:)
...
(:latex:) \[ \sum \frac{n^2-n}{n^3+7} \] (:latexend:)
...
(:latex:) \[ \frac{n^2-n}{n^3+7} \approx \frac{n^2}{n^3} = \frac{1}{n}. \] (:latexend:)
...
(:latex:) \begin{align*} \lim_{n \rightarrow \infty} \frac{a_n}{b_n} &= \lim_{n \rightarrow \infty} \frac{\left(n^2-n\right)/\left(n^3+7\right)}{1/n}
...
Determine whether (:latex:) \[ \sum \sin \left(\frac{1}{n}\right) \] (:latexend:)
...
(:latex:) \[ \sin \left(\frac{1}{n}\right) = \frac{1}{n} + O\left(\frac{1}{n^3}\right). \] (:latexend:)

Thus, ($\sin(1/n) \approx \frac{1}{n}$), which means ($\frac{1}{n}$) is a good candidate for ($b_n$) in the limit test. This will work:

(:latex:) \begin{align*} \lim_{n \rightarrow \infty} \frac{a_n}{b_n} &= \lim_{n \rightarrow \infty} \frac{\sin(1/n)}{1/n}
...
(:latex:) \[ \sum_{n=1}^{\infty} \frac{n+4}{n (2+n^4)^{1/3}} \] (:latexend:)

(:latex:) \[ \sum_{n=1}^{\infty} \frac{|\sin(n)^n|}{n^2} \] (:latexend:) 
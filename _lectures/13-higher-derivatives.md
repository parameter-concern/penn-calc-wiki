...
$$
\kappa = \frac{\vertf''\vert}{(1+(f')^2)^{3/2}}.
$$
...
$$
\vertf''\vert = \frac{1}{R} \left(1+(f')^2 \right)^{3/2}.
$$
...
$$
\begin{align*}
\kappa = \frac{1}{R} = \frac{\vertf''\vert}{(1+(f')^2)^{3/2}},
\end{align*}
$$
...
&= \sum_{k=0}^\infty \frac{h^k}{k!} \left(\frac{d}{dx} \bigg\vert_a \right)^k f
&= \sum_{k=0}^\infty \frac{1}{k!} \left(h \frac{d}{dx} \bigg\vert_a \right)^k f.
\end{align*}
$$
...
$$
f(a+h) = e^{\left(h\left.\frac{d}{dx}\right\vert_a\right)} f.
$$

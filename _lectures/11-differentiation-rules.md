...
- Use the information about functions $$f$$ and $$g$$ from the following table to compute the value of $$\displaystyle \left. \frac{d}{dx} \right\vert_{x=1}g(f(x))$$. 

$$
\[
			\begin{array}{\vertc\vertc\vertc\vertc\vertc\vert}\hline

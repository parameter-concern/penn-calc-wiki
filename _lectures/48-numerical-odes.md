...
$$
\begin{align*}
\frac{dx}{dt} = f(x,t) \quad & \Rightarrow \quad \frac{\Delta x}{\Delta t} = f(x,t)
& \Rightarrow \quad \frac{x_{n+1}-x_n}{h} = f(x_n,t_n),
\end{align*}
$$
...
$$
\begin{align*}
\lim_{N \rightarrow \infty} x_N &= \lim_{N \rightarrow \infty} \left(1+\frac{1}{N}\right)^N.
\end{align*}
$$
...
$$
\begin{align*}
\ln L &= \ln \left(\lim_{N \rightarrow \infty} \left(1+\frac{1}{N}\right)^N\right)
...
$$
\begin{align*}
x(t_0 + h) &= x(t_0) + h \cdot \frac{dx}{dt} \bigg\vert_{t=t_0} + O(h^2)
&= x_0 + h \cdot f(x_0,t_0) + O(h^2),
\end{align*}
$$
...
$$
\left(t_n + \frac{h}{2},x_n + \frac{\kappa}{2}\right).
$$
...
$$
\begin{align*}
x_{n+1} &= x_n + h \cdot f \left( x_n + \frac{\kappa}{2}, t_n + \frac{h}{2}\right)
\kappa &= h \cdot f(x_n,t_n).
\end{align*}
$$
...
$$
\begin{align*}
x_{n+1} &= x_n + \frac{1}{6} \left(\kappa_1 + 2 \kappa_2 + 2 \kappa_3 + \kappa_4 \right)
...
\kappa_4 &= h \cdot f \left(x_n + \kappa_3, t_n + h\right).
\end{align*}
$$
...
$$
\begin{align*}
x_1 &= x_0 + h \cdot f \left(x_0 + \frac{\kappa}{2}, t_0 + \frac{h}{2} \right)
...
$$
\begin{align*}
\kappa_3 &= h \cdot f \left( x_0 + \frac{\kappa_2}{2},t_0 + \frac{h}{2} \right)
...
$$
\begin{align*}
\kappa_4 &= h \cdot f \left( x_0 + \kappa_3,t_0 + h \right)
...
$$
\begin{align*}
x_1 &= x_0 + \frac{1}{6}(\kappa_1 + 2 \kappa_2 + 2 \kappa_3 + \kappa_4)

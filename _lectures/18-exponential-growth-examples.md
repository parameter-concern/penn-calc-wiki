...
(:latex:) \[ \frac{dI}{dt} = -\lambda I, \] (:latexend:)
...
(:latex:) \begin{align*} \lim_{n \rightarrow \infty} P\left(1+\frac{r}{n}\right)^{nk} &= \lim_{n \rightarrow \infty} P\left[\left(1+\frac{r}{n}\right)^n\right]^k
&= P e^{rk}. \end{align*} (:latexend:)
...
(:latex:) \begin{equation*} \text{\# years for the account to double } = \frac{70}{100r}. \end{equation*} (:latexend:)

In other words, the number of years is 70 divided by the annual percentage. Verify the Rule of 70. (:toggle hide show="Answer" box1:)

The problem asks for ($k$) when the balance has doubled. That is, find ($k$) such that

(:latex:) \begin{equation*} 2P = Pe^{rk}. \end{equation*} (:latexend:)

Dividing by ($P$) and taking logarithms gives ($rk = \ln(2)$), so ($k = \frac{\ln(2)}{r}$). Since ($\ln(2) \approx .7$), this shows that

(:latex:) \begin{align*} k &= \frac{\ln(2)}{r}
&\approx \frac{.7}{r}
&\approx \frac{70}{100r}, \end{align*} (:latexend:)
...
(:latex:) \[ WM(t) = WM(1667) e^{-\lambda (t-1667)} \] (:latexend:)
...
(:latex:) \[ WC(t) = WC(1400)e^{-\lambda(t-1400)}. \] (:latexend:)

From the given information, we have that

(:latex:) \[ \frac{WM(2013)}{WM(1667)} = \frac{4}{5}. \] (:latexend:)

And according to the above formula, we have

(:latex:) \[ \frac{WM(1667)e^{-\lambda \cdot 346}}{WM(1667)} = \frac{4}{5}. \] (:latexend:)

The factors of ($WM(1667)$) cancel, leaving

(:latex:) \[ e^{-\lambda \cdot 346} = \frac{4}{5}. \] (:latexend:)

Taking the logarithm of both sides and dividing by ($-346$) gives

(:latex:) \[ \lambda = \frac{-\ln(4/5)}{346} \approx 6.5 \times 10^{-4}. \] (:latexend:)
...
(:latex:) \begin{align*} \frac{WC(1600)}{WC(1400)} &= \frac{WC(1400)e^{-\lambda(200)}}{WC(1400)}
&= e^{-\lambda(200)}
&\approx .88 \end{align*} (:latexend:)
...
(:latex:) \begin{equation*} \frac{dT}{dt} = k(A-T), \end{equation*} (:latexend:)

for some positive constant ($k$). Separating gives

(:latex:) \begin{equation*} \frac{dT}{T-A} = -k\,dt, \end{equation*} (:latexend:)

...
Suppose the region bounded by $$y = 3x-x^2$$ and $$y = x$$ is revolved about the $$y$$-axis. What is the volume of the resulting solid? <button class="toggle" data-box="#box1">Answer</button>
...
&= 2 \pi \left(\frac{2}{3}x^3 - \frac{1}{4}x^4 \right) \bigg\vert_{x=0}^2
&= \frac{8}{3} \pi.
\end{align*}
$$
...
$$
dV = \pi(R^2-r^2) \, \hbox{$dx$ or $dy$}.
$$

**Example**

Given the region bounded by $$y = 3x-x^2$$ and $$y = x$$, find the volume of the solid resulting from revolving the region about the $$x$$-axis. <button class="toggle" data-box="#box2">Answer</button>
...
&= \pi \left( \frac{8}{3} x^3 - \frac{3}{2}x^4 + \frac{1}{5}x^5 \right) \bigg\vert_{x=0}^2
&= \frac{56}{15}\pi.
\end{align*}
$$
...
\begin{align*}
V &= \int dV
&= \int_{x = R-a}^{R+a} 4 \pi x \sqrt{a^2 - (x-R)^2} \, dx.
\end{align*}
$$
...
$$
\begin{align*}
\int_{x = R-a}^{R+a} 4 \pi x \sqrt{a^2 - (x-R)^2} \, dx &= \int_{u = -a}^a 4 \pi (u+R)\sqrt{a^2 - u^2} \, du
&= \int_{u=-a}^a 4 \pi u \sqrt{a^2-u^2} \, du + \int_{u=-a}^a 4 \pi R \sqrt{a^2-u^2} \, du.
\end{align*}
$$
...
$$
\int_{u=-a}^a 4 \pi u \sqrt{a^2-u^2} \, du = 0.
$$

The second integral can be found by noting that

$$
\int_{u=-a}^a 2 \sqrt{a^2-u^2} \, du
$$
...
$$
\begin{align*}
\int_{u=-a}^a 4 \pi R \sqrt{a^2-u^2} \, du &= 2 \pi R \int_{u=-a}^a 2 \sqrt{a^2-u^2} \, du
&= 2\pi R (\pi a^2)
&= 2 \pi^2 R a^2.
\end{align*}
$$
...
$$
(x-R)^2 + y^2 = a^2 \quad \Rightarrow \quad x = R \pm \sqrt{a^2-y^2}.
$$
...
$$
\begin{align*}
dV &= \left[ \pi(R+\sqrt{a^2-y^2})^2 - \pi (R-\sqrt{a^2-y^2})^2 \right] \, dy
&= 4 \pi R \sqrt{a^2-y^2} \, dy.
\end{align*}
$$

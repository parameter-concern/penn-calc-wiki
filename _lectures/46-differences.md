...
$$
\begin{equation*} (\Delta a)_n = a_{n+1} - a_{n}. \end{equation*}
$$

The backward difference of $$a$$, denoted by $$(\nabla a)_n$$, is defined by

$$
\begin{equation*} (\nabla a)_n = a_n - a_{n-1}. \end{equation*}
$$

This can be interpreted as the change in output over the change in input:

$$
(\Delta a)_n = \frac{a(n+1) - a(n)}{(n+1)-n} = \frac{a_{n+1} - a_n}{1} = a_{n+1} - a_n,
$$
...
$$
\begin{equation*} \begin{array}{ccccccccccc} a &=& 0 & 1 & 8 & 27 & 64 & 125 & 216 & 343 & \ldots
\Delta a &=& 1 & 7 & 19 & 37 & 61 & 91 & 127 & \ldots &
\Delta^2 a &=& 6 & 12 & 18 & 24 & 30 & 36 & \ldots & &
\Delta^3 a &=& 6 & 6 & 6 & 6 & 6 & \ldots & & &
\Delta^4 a &=& 0 & 0 & 0 & 0 & \ldots & &&& \end{array} \end{equation*}
$$
...
$$
n^{\underline{k}} = n(n-1)(n-2) \dotsb (n-k+1), \qquad n^{\underline 0} = 1.
$$
...
$$
\begin{align*}
n^{\underline{3}} + 3 n^{\underline{2}} &= (n^3 - 3n^2 + 2n) + 3(n^2-n)
&= n^3 - n.
\end{align*}
$$
...
$$
n^{\underline{3}} + 3n^{\underline{2}} + n^{\underline{1}} = n^3.
$$
...
$$
\begin{align*}
\Delta n^3 &= \Delta \left(n^{\underline{3}} + 3n^{\underline{2}} + n^{\underline{1}} \right)
...
$$
\sum_{k=0}^\infty \frac{n^{\underline k}}{k!} = 1 + n + \frac{n(n-1)}{2!} + \frac{n(n-1)(n-2)}{3!} + \dotsb
$$
...
\begin{align*}
\Delta^k &= (E-I)^k
&= \sum_{i=0}^k (-1)^{k-i} {k \choose i} E^i
\end{align*}
$$
